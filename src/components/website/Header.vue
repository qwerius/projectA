        ...
        <div class="lg:flex lg:items-center lg:justify-between">
          ...
          <div class="absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out  lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center">
            ...
            <div class="hidden lg:flex items-center mt-4 lg:mt-0">
              <!-- Notifications -->
              <button v-if="isAuth" class="hidden mx-4 text-primary  transition-colors duration-300 transform lg:block  hover:text-gray-700 dark:hover:text-gray-400 focus:text-gray-700 dark:focus:text-gray-400 focus:outline-none" aria-label="show notifications">
              ...
              <button type="button" class="flex items-center focus:outline-none" aria-label="toggle profile dropdown">
                <div v-if="isAuth" class="w-8 h-8 overflow-hidden border-2 border-gray-400 rounded-full">
