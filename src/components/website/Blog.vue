...
<div   class="mx-auto  px-4 pb-20 ">
    <div data-aos="fade-up" data-aos-anchor-placement="bottom-bottom data" data-aos-duration="550" class="md:flex justify-between items-center mb-8">
      <div>
        ...
        <p class="text-primary">
          Berita seputar perkebunan sawit
        </p>
      </div>
    ...
    <div data-aos="fade-up" data-aos-anchor-placement="bottom-bottom data" data-aos-duration="400" class="grid md:grid-flow-col md:grid-cols-3 md:grid-rows-1 gap-4">
        <!-- card-->
      <div class="rounded border md:shadow w-full overflow-hidden">
        <div>
          <a href="#">
            <img class="w-full h-48 object-cover" src="https://images.pexels.com/photos/3246161/pexels-photo-3246161.jpeg" alt="card 1" />
          </a>
        </div>
        ...
        <div class="px-4 py-4 bg-card">
          ...
          <h3 class="font-semibold text-primary my-4 hover:underline text-lg">
      ...
      <div class="rounded border md:shadow w-full overflow-hidden">
        <div>
          <a href="#">
            <img class="w-full h-48 object-cover" src="https://images.pexels.com/photos/2950868/pexels-photo-2950868.jpeg" alt="card 1" />
          </a>
        </div>
      ...
      <div class="rounded border md:shadow w-full overflow-hidden">
        <div>
          <a href="#">
            <img class="w-full h-48 object-cover" src="https://images.pexels.com/photos/1026230/pexels-photo-1026230.jpeg" alt="card 1" />
          </a>
        </div>
